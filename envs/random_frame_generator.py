...
# =============================================================================
# Custom Gym environment: RandomFrameGenerator
# This environment presents a randomly selected frame to the agent at each timestep.
# It is used to check how the visual input affects agent's timing behaviour
# =============================================================================
class RandomFrameGenerator(gym.Env):
    ...
    def __init__(self, train_video_path: str, test_video_folder: str, video_fps: int, frame_size: Tuple[int, int],
        ...
        # load video and shuffle frames
        fullvideo_frames = self.load_fullvideo(self.video_path, self.video_fps)
        random.shuffle(fullvideo_frames)
        self.fullvideo_frames = fullvideo_frames
